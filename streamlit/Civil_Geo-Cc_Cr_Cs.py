...
Pc = st.sidebar.selectbox('Index of Cc starting point', np.arange(nx), 105) 
Pr = st.sidebar.selectbox('Index of Cr starting point', np.arange(nx), 70) 
st.sidebar.markdown('#### Seclect Index')
Cc1000 = st.sidebar.slider('Cc (Compression Index) * 1000', 0, 200, 95) 
Cr1000 = st.sidebar.slider('Cr (Recompression Index) * 1000', 0, 200, 8) 
Cs1000 = st.sidebar.slider('Cs (Swelling Index) * 1000', 0, 200, 25) 
Cc = Cc1000 / 1000
Cr = Cr1000 / 1000
Cs = Cs1000 / 1000
