...
plt.text(np.log10(xmax)-0.5,y[Pc]+0.5,'Cc: '+str(round(Cc,3)))
plt.text(np.log10(xmax)-0.5,Cr_y2+0.1,'Cr: '+str(round(Cr,3)))
plt.text(np.log10(xmax)-0.5,Cs_y2+0.1,'Cs: '+str(round(Cs,3)))
## Casagrande
