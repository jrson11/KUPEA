...
Pc = st.sidebar.selectbox('Index of max Cc starting point', np.arange(nx), 100) 
...
Pc_kPa = st.sidebar.slider('Pc [kPa_', 0.0, 500.0, 100.0) 
Pc_MPa = Pc_kPa / 1000
...
#
plt.plot([np.log(Pc_kPa),np.log(Pc_kPa)],[ymin,y[Px]], 'k-')
st.text(y[Px])
#
plt.xlabel('log(x)')
plt.ylabel('y')
